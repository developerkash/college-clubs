          ...
          <div>
            ...
            <div className="relative">
              ...
              {/* Error Icon */}
              {
                ...
                <small className='text-danger'>{adduser.errors.email}</small>
              }
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              {
                ...
                <small className='text-danger'>{adduser.errors.password}</small>
              }
              <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                <svg
                  className="size-5 text-red-500"
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              {
                ...
                <small className='text-danger'>{adduser.errors.confirm_password}</small>
              }
              <div className="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                <svg
                  className="size-5 text-red-500"
