...
const Contact = () => {
  ...
  return (
    <section className="bg-orange-200 dark:bg-slate-800" id="contact">
                ...
                <div className="mb-6">
                  ...
                  <div className="mx-0 mb-1 sm:mb-4">
                    ...
                    <textarea
                      ...
                      className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"
                      onChange={contactForm.handleChange}
                      value={contactForm.values.textarea}
                    />
                    {contactForm.touched.textarea && (
                      <small className="text-red-500">
                        {contactForm.errors.textarea}
                      </small>
                    )}
                  </div>
                </div>
