...
const ViewClub = () => {
                  ...
                  <div className="w-1/3 bg-white p-4">
                    ...
                    <ul className="list-disc pl-6">
                      <li>
                        ...
                        <div>
                          Held on April 15, 2024, showcased innovative projects
                          by club members.
                        </div>
                      </li>
                      <li>
                        ...
                        <div>
                          Conducted on May 10, 2024, focused on sustainable
                          energy solutions.
                        </div>
                      </li>
                      <li>
                  ...
                  <div className="mb-6 p-4 bg-white w-2/3">
                    ...
                    <ul className="list-disc pl-6">
                      <li>
                        ...
                        <div>
                          Any student with a passion for science is welcome to
                          join, regardless of their major.
                        </div>
                      </li>
                      <li>
                        <strong> Introductory Meeting:</strong>
                        <div>
                          New members must attend at least one introductory
                          meeting to get acquainted with the club's activities
                          and expectations.
                        </div>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <div>
                          We welcome all curious minds and enthusiastic
                          learners, no prior scientific research experience
                          required.
                        </div>
                      </li>
                    </ul>
                  ...
                  <div className="mb-6 p-4 bg-white w-1/3">
                    ...
                    <ul className="list-disc pl-6">
                      ...
                      <li>
                        ...
                        <div>
                          {" "}
                          There may be extra costs for optional trips and
                          special events. Fundraising opportunities will be
                          available to help offset these expenses.
                        </div>
                      </li>
                    </ul>
                  </div>
                  ...
                  >
                    <div className=" px-4 bg-white">
                      ...
                      <p>
                        The Science Club is dedicated to fostering a deep
                        appreciation and understanding of science among students
                        through hands-on exploration, collaborative learning,
                        and community engagement. <b>Our mission is to:</b>
                        <ul>
                          <li>
                            {" "}
                            <b>Inspire Curiosity:</b> Spark interest in science
                            by providing engaging and interactive learning
                            experiences.
                          </li>
                          <li>
                            {" "}
                          ...
                          <li>
                            {" "}
                            <b>Cultivate Leadership:</b> Develop leadership
                            skills and teamwork among members through organizing
  ...
  return (
    <>
      <section className="bg-blue-500 mt-7 min-h-screen">
