  ...
  const uploadFile = (e) => {
    ...
    fetch("http://localhost:5000/util/uploadfile", {
      ...
      if (res.status == 200) {
        ...
        eventDetails.values.image = file.name;
      }
    });
  };
        ...
        <div className="bg-indigo-50 p-5">
          ...
          <div className="mb-4">
            ...
            >
              ...
              <option value="Academic">Academic and Professional Clubs</option>                                                                          
              <option value="Arts">Arts and Culture Clubs</option>
              <option value="Social">Social and Community Service Clubs</option>
              <option value="Politcs">Political and Advocacy Clubs</option>
              <option value="Sports">Sports and Recreation Clubs</option>
              <option value="Technology">Technology and Innovation Clubs</option>
            </select>
          </div>
          {/* Club Type */}
          <div className="mb-4">
